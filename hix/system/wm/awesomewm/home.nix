...
in {
    home.file = {
        ...
        ".config/awesome/themes/marrissa/theme.lua".text = ''
            ...
            local bg_path = os.getenv('HOME') .. '/.local/share/backgrounds/'
            ...
            theme.hotkeys_description_font  = theme.system_font .. " Italic 12"
            ...
            theme.notification_fg = "${c.bright_white}"
            -- notification_[width|height|margin]
            -- notification_[border_color|border_width|shape|opacity]

            -- Variables set for theming the menu:
            -- menu_[bg|fg]_[normal|focus]
            theme.menu_bg_focus = "${c.bright_cyan}"
