{retrofuture, ...}: {
    home.file = {
        ".config/eww".source = "${retrofuture}/config/eww";
        ".config/hypr".source = "${retrofuture}/config/hypr";
        ".config/kitty".source = "${retrofuture}/config/kitty";
        ".config/waybar".source = "${retrofuture}/config/waybar";
        ".config/wofi".source = "${retrofuture}/config/wofi";
        ".themes/diinki-retro-dark".source = "${retrofuture}/gtk_theme/diinki-retro-dark";
        ".config/sway".text = ''
          ...
          font pango:Maple Mono Regular 14
          ...
          output eDP-1 pos 0 0 res 2560x1440@144.001Hz
          # =================================================================
