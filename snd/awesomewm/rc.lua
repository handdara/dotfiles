...
local sys_manage_cmd = terminal_cmd .. [[bash -c "$HOME/.local/scripts/mg" ; sleep '0.15']]
...
local start_menu_launcher = awful.widget.launcher({
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.tasks_widget = awful.widget.tasklist {
        screen          = s,
...
root.buttons(gears.table.join(
    awful.button({}, 3, function() start_menu:toggle() end),
...
local globalkeys = gears.table.join(
    ...
    awful.key({ super, }, "w", function() start_menu:show() end, { description = "show main menu", group = "awesome" }),
