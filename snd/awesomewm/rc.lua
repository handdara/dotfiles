...
mytextclock:buttons(gears.table.join(
    awful.button({}, 1, function()
        mycal.visible = not mycal.visible
        if mycal.visible then
            mycal:move_next_to(mouse.current_widget_geometry)
        end
    end),
    awful.button({}, 3, function()
        mycal_yr.visible = not mycal_yr.visible
        if mycal_yr.visible then
            mycal_yr:move_next_to(mouse.current_widget_geometry)
        end
    end)
))
